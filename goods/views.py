    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            if 'category_slug' in self.kwargs:
                ...
                products = goods_models.Products.objects.filter(category__slug=category_slug)
            else:
...
class ProductPage(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            total_products_in_category = goods_models.Products.objects.filter(category=category).count()
